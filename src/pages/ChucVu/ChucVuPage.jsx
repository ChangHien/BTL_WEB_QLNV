          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {loading ? (
                ...
                data.map((record) => (
                  <tr key={record.ma_chuc_vu} className="bg-white border-b hover:bg-blue-50 transition-colors">
                    <td className="px-6 py-4 font-medium text-gray-900">
                      <span className="bg-purple-100 text-purple-800 text-xs font-semibold px-2.5 py-0.5 rounded border border-purple-400">
                        {record.ma_chuc_vu}
                      </span>
                    </td>
